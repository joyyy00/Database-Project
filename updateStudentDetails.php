...
$f_name = $l_name = $number_of_classes = "";
$f_name_err = $l_name_err = $number_of_classes_err = "" ;
// Form default values
...
// Post information about the student when the form is submitted
// Processing form data when form is submitted
if($_SERVER["REQUEST_METHOD"] == "POST"){
    // the id is hidden and can not be changed
    $student_id = $_SESSION["student_id"];
    // Validate form data this is similar to the create Student file
    // Validate name
    $f_name = trim($_POST["f_name"]);
    if(empty($f_name)){
        $f_name_err = "Please enter a first name.";
